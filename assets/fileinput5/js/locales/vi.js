...
(function (factory) {
    ...
    $.fn.fileinputLocales['vi'] = {
        ...
        removeLabel: 'Gỡ bỏ',
        removeTitle: 'Bỏ tập tin đí chọn',
        cancelLabel: 'Hủy',
        cancelTitle: 'Hủy upload',
        pauseLabel: 'Pause',
        pauseTitle: 'Pause ongoing upload',
        uploadLabel: 'Upload',
        uploadTitle: 'Upload tập tin đí chọn',
        msgNo: 'Không',
        ...
        msgFilePreviewAborted: 'Đí dừng xem trước tập tin "{name}".',
        msgFilePreviewError: 'Đí xảy ra lỗi khi đọc tập tin "{name}".',
        ...
        msgUploadAborted: 'Đí dừng upload',
        ...
        msgFoldersNotAllowed: 'Chỉ kéo thả tập tin! Đí bỏ qua {n} thư mục.',
        ...
        fileActionSettings: {
            ...
            indicatorSuccessTitle: 'Đí upload',
