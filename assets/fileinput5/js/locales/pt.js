...
(function (factory) {
    ...
    $.fn.fileinputLocales['pt'] = {
        ...
        msgFileNotFound: 'Ficheiro "{name}" nío encontrado.',
        msgFileSecured: 'Restrições de segurança impedem a leitura do ficheiro "{name}".',
        msgFileNotReadable: 'Ficheiro "{name}" nío pode ser lido.',
        msgFilePreviewAborted: 'Pré-visualizaçío abortado para o ficheiro "{name}".',
        msgFilePreviewError: 'Ocorreu um erro ao ler o ficheiro "{name}".',
        msgInvalidFileName: 'Caracteres inválidos ou nío suportados no nome de ficheiro "{name}".',
        msgInvalidFileType: 'Tipo inválido para o ficheiro "{name}". Apenas ficheiros "{types}" sío suportados.',
        msgInvalidFileExtension: 'Extensío inválida para o ficheiro "{name}". Apenas ficheiros "{extensions}" sío suportados.',
        msgFileTypes: {
            'image': 'imagem',
            'html': 'HTML',
            'text': 'texto',
        ...
        msgUploadEmpty: 'Nío existem dados válidos disponíveis para o envio.',
        msgUploadError: 'Erro de Envio',
        msgDeleteError: 'Erro de Eliminaçío',
        ...
        msgImageWidthLarge: 'Largura da imagem "{name}" nío pode exceder {size} px.',
        msgImageHeightLarge: 'Altura da imagem "{name}" nío pode exceder {size} px.',
        msgImageResizeError: 'Níofoi possível obter as dimensões da imagem para redimensionar.',
        msgImageResizeException: 'Erro ao redimensionar a imagem.<pre>{errors}</pre>',
        msgAjaxError: 'Ocorreu um erro durante a operaçío {operation}. Por favor tente de novo mais tarde.',
        ...
        previewZoomButtonTitles: {
            ...
            fullscreen: 'Alternar entre ecrí completo',
