...
<head>
    ...
    <style>body{font-family:dejavusans,sans-serif;color:#172033;font-size:10px;margin:10px 12px;padding:0}.header{border-bottom:2px solid #1d4ed8;padding-bottom:6px;margin-bottom:8px}.title{font-size:18px;font-weight:bold;color:#0f172a}.subtitle{font-size:10px;color:#475569;margin-top:2px}.section-title{font-size:12px;font-weight:bold;color:#0f172a;margin:6px 0 4px}table{width:100%;border-collapse:collapse;margin-bottom:4px}td,th{border:1px solid #d7dee8;padding:5px 7px}th{background:#e2e8f0;color:#0f172a;text-align:left;font-size:9px;padding:4px 7px}.label{background:#f8fafc;font-weight:bold;color:#334155;white-space:nowrap;font-size:9px;padding:5px 7px;width:18%}.label-small{background:#f8fafc;font-weight:bold;color:#334155;white-space:nowrap;font-size:8px;padding:4px 6px;width:14%}.qr-value{font-size:8px;line-height:1.2;word-break:normal;overflow-wrap:break-word}.money{text-align:right;font-weight:bold}.note{margin-top:6px;padding:6px 8px;border:1px solid #cbd5e1;background:#f8fafc;font-size:9px}.signature{margin-top:5px;width:100%;text-align:center;color:#475569;padding-top:5px}.signature img{display:block;margin:0 auto 6px;max-width:180px;max-height:60px}.signature-line{padding-top:8px;font-size:11px;font-weight:bold;color:#0f172a}.beneficiary-section{margin-bottom:6px}.vigencia-row{display:flex;gap:12px;margin-top:2px;font-size:9px;padding:2px 0}.vigencia-item{flex:1;padding:3px 6px;background:#f8fafc;border-radius:4px}.vigencia-label{font-weight:bold;color:#0f172a;display:block;margin-bottom:1px}.two-columns{display:flex;gap:12px;margin-top:4px}.column{flex:1}.signature-name{font-size:11px;color:#475569;margin-top:2px;font-weight:normal;letter-spacing:1px;padding:90px 0 5px 0}.obs-text{font-size:8px;margin-top:2px;color:#475569;padding:2px 5px;background:#f1f5f9;border-radius:3px}.access-block{margin-top:8px;border:1px solid #cbd5e1;background:#f8fafc;padding:12px 15px}.access-table{margin-bottom:0}.access-table td{vertical-align:middle;padding:8px 12px}.nip-value{font-size:20px;font-weight:bold;letter-spacing:3px;color:#0f172a;text-align:center}.qr-image-cell{width:130px;text-align:center}.qr-image{width:110px;height:110px;object-fit:contain}.qr-caption{font-size:7px;color:#475569;margin-top:2px;word-break:break-all}@page{margin:10mm 12mm 10mm 12mm}.compact td{padding:4px 6px}.detalle-table td{font-size:9px}.detalle-table th{font-size:8px}.beneficiary-table td{padding:5px 8px;font-size:10px}.beneficiary-table .label{font-size:10px;padding:5px 8px}.signature-space{height:40px}</style>
</head>
<body>
    <section>
        <div class="header">
        ...
        <div class="signature">
            ...
            <?php endif; ?>
            <div class="signature-name" style="border-bottom: 2px solid #64748b; width: 60%; margin: 0 auto; padding-bottom: 5px;"></div>
